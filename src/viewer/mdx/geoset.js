...
Geoset.prototype = {
    ...
    ctx.vertexAttribPointer(gl.getParameter("a_position"), 3, ctx.FLOAT, false, 12, this.offsets[0]);
    //ctx.vertexAttribPointer(gl.getParameter("a_normal"), 3, ctx.FLOAT, false, 12, this.offsets[1]);
    ctx.vertexAttribPointer(gl.getParameter("a_uv"), 2, ctx.FLOAT, false, 8, this.offsets[1] + coordId * this.uvSetSize);
    ...
    //ctx.vertexAttribPointer(gl.getParameter("a_normal"), 3, ctx.FLOAT, false, 12, this.offsets[1]);
    ctx.vertexAttribPointer(gl.getParameter("a_uv"), 2, ctx.FLOAT, false, 8, this.offsets[1] + coordId * this.uvSetSize);
    ctx.vertexAttribPointer(gl.getParameter("a_bones"), 4, ctx.FLOAT, false, 16, this.offsets[2]);
    ctx.vertexAttribPointer(gl.getParameter("a_bone_number"), 1, ctx.FLOAT, false, 4, this.offsets[3]);
