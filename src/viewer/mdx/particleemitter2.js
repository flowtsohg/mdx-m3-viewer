...
ParticleEmitter2.prototype = {
  ...
  render: function (textureMap) {
    ...
    var particle, index, position, scale, left, top, right, bottom, color, r, g, b, a, px, py, pz;
    ...
    for (var i = 0, l = keys.length; i < l; i++) {
      ...
      left = this.cellWidth * particle.column;
      top = this.cellHeight * particle.row;
      right = this.cellWidth * (particle.column + 1);
      bottom = this.cellHeight * (particle.row + 1);
