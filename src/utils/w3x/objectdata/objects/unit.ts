...
export class OEUnit extends OEObject<FetchType> {
  ...
  fetch(): FetchType { return { requiredAnimationNames: this.requiredAnimationNames, iconGameInterface: this.iconGameInterface, requiredAnimationNamesAttachments: this.requiredAnimationNamesAttachments, requiredAttachmentLinkNames: this.requiredAttachmentLinkNames, tooltipAwaken: this.tooltipAwaken, requiredBoneNames: this.requiredBoneNames, construction: this.construction, structuresBuilt: this.structuresBuilt, buttonPositionX: this.buttonPositionX, buttonPositionY: this.buttonPositionY, casterUpgradeArt: this.casterUpgradeArt, casterUpgradeNames: this.casterUpgradeNames, casterUpgradeTips: this.casterUpgradeTips, dependencyEquivalents: this.dependencyEquivalents, nameEditorSuffix: this.nameEditorSuffix, hotkey: this.hotkey, loopingFadeInRate: this.loopingFadeInRate, loopingFadeOutRate: this.loopingFadeOutRate, itemsMade: this.itemsMade, attack1ProjectileArc: this.attack1ProjectileArc, attack2ProjectileArc: this.attack2ProjectileArc, attack1ProjectileArt: this.attack1ProjectileArt, attack2ProjectileArt: this.attack2ProjectileArt, attack1ProjectileHomingEnabled: this.attack1ProjectileHomingEnabled, attack2ProjectileHomingEnabled: this.attack2ProjectileHomingEnabled, attack1ProjectileSpeed: this.attack1ProjectileSpeed, attack2ProjectileSpeed: this.attack2ProjectileSpeed, movement: this.movement, name: this.name, properNames: this.properNames, random: this.random, requirementsTiersUsed: this.requirementsTiersUsed, requirements: this.requirements, requirementsTier2: this.requirementsTier2, requirementsTier3: this.requirementsTier3, requirementsTier4: this.requirementsTier4, requirementsTier5: this.requirementsTier5, requirementsTier6: this.requirementsTier6, requirementsTier7: this.requirementsTier7, requirementsTier8: this.requirementsTier8, requirementsTier9: this.requirementsTier9, requirementsLevels: this.requirementsLevels, researchesAvailable: this.researchesAvailable, revivesDeadHeroes: this.revivesDeadHeroes, tooltipRevive: this.tooltipRevive, iconScoreScreen: this.iconScoreScreen, itemsSold: this.itemsSold, unitsSold: this.unitsSold, special: this.special, target: this.target, tooltipBasic: this.tooltipBasic, unitsTrained: this.unitsTrained, heroRevivalLocations: this.heroRevivalLocations, tooltipExtended: this.tooltipExtended, upgradesTo: this.upgradesTo, normal: this.normal, defaultActiveAbility: this.defaultActiveAbility, hero: this.hero, startingAgility: this.startingAgility, agilityPerLevel: this.agilityPerLevel, buildTime: this.buildTime, goldBountyAwardedNumberOfDice: this.goldBountyAwardedNumberOfDice, goldBountyAwardedBase: this.goldBountyAwardedBase, goldBountyAwardedSidesPerDie: this.goldBountyAwardedSidesPerDie, lumberBountyAwardedNumberOfDice: this.lumberBountyAwardedNumberOfDice, lumberBountyAwardedBase: this.lumberBountyAwardedBase, lumberBountyAwardedSidesPerDie: this.lumberBountyAwardedSidesPerDie, collisionSize: this.collisionSize, defenseBase: this.defenseBase, defenseType: this.defenseType, defenseUpgradeBonus: this.defenseUpgradeBonus, foodProduced: this.foodProduced, foodCost: this.foodCost, goldCost: this.goldCost, repairGoldCost: this.repairGoldCost, hitPointsMaximumBase: this.hitPointsMaximumBase, startingIntelligence: this.startingIntelligence, intelligencePerLevel: this.intelligencePerLevel, isABuilding: this.isABuilding, level: this.level, lumberCost: this.lumberCost, repairLumberCost: this.repairLumberCost, manaInitialAmount: this.manaInitialAmount, manaMaximum: this.manaMaximum, speedMaximum: this.speedMaximum, speedMinimum: this.speedMinimum, neutralBuildingValidAsRandomBuilding: this.neutralBuildingValidAsRandomBuilding, sightRadiusNight: this.sightRadiusNight, placementRequires: this.placementRequires, primaryAttribute: this.primaryAttribute, hitPointsRegenerationRate: this.hitPointsRegenerationRate, manaRegeneration: this.manaRegeneration, hitPointsRegenerationType: this.hitPointsRegenerationType, repairTime: this.repairTime, groupSeparationEnabled: this.groupSeparationEnabled, groupSeparationGroupNumber: this.groupSeparationGroupNumber, groupSeparationParameter: this.groupSeparationParameter, groupSeparationPriority: this.groupSeparationPriority, placementPreventedBy: this.placementPreventedBy, sightRadiusDay: this.sightRadiusDay, speedBase: this.speedBase, stockMaximum: this.stockMaximum, stockReplenishInterval: this.stockReplenishInterval, stockStartDelay: this.stockStartDelay, stockInitialAfterStartDelay: this.stockInitialAfterStartDelay, startingStrength: this.startingStrength, strengthPerLevel: this.strengthPerLevel, tilesets: this.tilesets, unitClassification: this.unitClassification, upgradesUsed: this.upgradesUsed, aIPlacementRadius: this.aIPlacementRadius, aIPlacementType: this.aIPlacementType, canBuildOn: this.canBuildOn, canFlee: this.canFlee, sleeps: this.sleeps, transportedSize: this.transportedSize, deathTimeSeconds: this.deathTimeSeconds, deathType: this.deathType, useExtendedLineOfSight: this.useExtendedLineOfSight, formationRank: this.formationRank, canBeBuiltOn: this.canBeBuiltOn, heightMinimum: this.heightMinimum, height: this.height, type: this.type, properNamesUsed: this.properNamesUsed, orientationInterpolation: this.orientationInterpolation, pathingMap: this.pathingMap, pointValue: this.pointValue, priority: this.priority, propulsionWindowDegrees: this.propulsionWindowDegrees, race: this.race, placementRequiresWaterRadius: this.placementRequiresWaterRadius, targetedAs: this.targetedAs, turnRate: this.turnRate, armorType: this.armorType, animationBlendTimeSeconds: this.animationBlendTimeSeconds, tintingColor3Blue: this.tintingColor3Blue, shadowTextureBuilding: this.shadowTextureBuilding, categorizationCampaign: this.categorizationCampaign, allowCustomTeamColor: this.allowCustomTeamColor, canDropItemsOnDeath: this.canDropItemsOnDeath, elevationSamplePoints: this.elevationSamplePoints, elevationSampleRadius: this.elevationSampleRadius, modelFile: this.modelFile, modelFileExtraVersions: this.modelFileExtraVersions, fogOfWarSampleRadius: this.fogOfWarSampleRadius, tintingColor2Green: this.tintingColor2Green, displayAsNeutralHostile: this.displayAsNeutralHostile, placeableInEditor: this.placeableInEditor, maximumPitchAngleDegrees: this.maximumPitchAngleDegrees, maximumRollAngleDegrees: this.maximumRollAngleDegrees, scalingValue: this.scalingValue, neutralBuildingShowsMinimapIcon: this.neutralBuildingShowsMinimapIcon, heroHideHeroInterfaceIcon: this.heroHideHeroInterfaceIcon, heroHideHeroMinimapDisplay: this.heroHideHeroMinimapDisplay, heroHideHeroDeathMessage: this.heroHideHeroDeathMessage, hideMinimapDisplay: this.hideMinimapDisplay, occluderHeight: this.occluderHeight, tintingColor1Red: this.tintingColor1Red, animationRunSpeed: this.animationRunSpeed, selectionScale: this.selectionScale, scaleProjectiles: this.scaleProjectiles, selectionCircleOnWater: this.selectionCircleOnWater, selectionCircleHeight: this.selectionCircleHeight, shadowImageHeight: this.shadowImageHeight, hasWaterShadow: this.hasWaterShadow, shadowImageWidth: this.shadowImageWidth, shadowImageCenterX: this.shadowImageCenterX, shadowImageCenterY: this.shadowImageCenterY, categorizationSpecial: this.categorizationSpecial, teamColor: this.teamColor, hasTilesetSpecificData: this.hasTilesetSpecificData, groundTexture: this.groundTexture, shadowImageUnit: this.shadowImageUnit, unitSoundSet: this.unitSoundSet, useClickHelper: this.useClickHelper, animationWalkSpeed: this.animationWalkSpeed, acquisitionRange: this.acquisitionRange, attack1AttackType: this.attack1AttackType, attack2AttackType: this.attack2AttackType, attack1AnimationBackswingPoint: this.attack1AnimationBackswingPoint, attack2AnimationBackswingPoint: this.attack2AnimationBackswingPoint, animationCastBackswing: this.animationCastBackswing, animationCastPoint: this.animationCastPoint, attack1CooldownTime: this.attack1CooldownTime, attack2CooldownTime: this.attack2CooldownTime, attack1DamageLossFactor: this.attack1DamageLossFactor, attack2DamageLossFactor: this.attack2DamageLossFactor, attack1DamageNumberOfDice: this.attack1DamageNumberOfDice, attack2DamageNumberOfDice: this.attack2DamageNumberOfDice, attack1DamageBase: this.attack1DamageBase, attack2DamageBase: this.attack2DamageBase, attack1AnimationDamagePoint: this.attack1AnimationDamagePoint, attack2AnimationDamagePoint: this.attack2AnimationDamagePoint, attack1DamageUpgradeAmount: this.attack1DamageUpgradeAmount, attack2DamageUpgradeAmount: this.attack2DamageUpgradeAmount, attack1AreaOfEffectFullDamage: this.attack1AreaOfEffectFullDamage, attack2AreaOfEffectFullDamage: this.attack2AreaOfEffectFullDamage, attack1AreaOfEffectMediumDamage: this.attack1AreaOfEffectMediumDamage, attack2AreaOfEffectMediumDamage: this.attack2AreaOfEffectMediumDamage, attack1DamageFactorMedium: this.attack1DamageFactorMedium, attack2DamageFactorMedium: this.attack2DamageFactorMedium, projectileImpactZSwimming: this.projectileImpactZSwimming, projectileImpactZ: this.projectileImpactZ, projectileLaunchZSwimming: this.projectileLaunchZSwimming, projectileLaunchX: this.projectileLaunchX, projectileLaunchY: this.projectileLaunchY, projectileLaunchZ: this.projectileLaunchZ, minimumAttackRange: this.minimumAttackRange, attack1AreaOfEffectSmallDamage: this.attack1AreaOfEffectSmallDamage, attack2AreaOfEffectSmallDamage: this.attack2AreaOfEffectSmallDamage, attack1DamageFactorSmall: this.attack1DamageFactorSmall, attack2DamageFactorSmall: this.attack2DamageFactorSmall, attack1Range: this.attack1Range, attack2Range: this.attack2Range, attack1RangeMotionBuffer: this.attack1RangeMotionBuffer, attack2RangeMotionBuffer: this.attack2RangeMotionBuffer, attack1ShowUI: this.attack1ShowUI, attack2ShowUI: this.attack2ShowUI, attack1DamageSidesPerDie: this.attack1DamageSidesPerDie, attack2DamageSidesPerDie: this.attack2DamageSidesPerDie, attack1DamageSpillDistance: this.attack1DamageSpillDistance, attack2DamageSpillDistance: this.attack2DamageSpillDistance, attack1DamageSpillRadius: this.attack1DamageSpillRadius, attack2DamageSpillRadius: this.attack2DamageSpillRadius, attack1AreaOfEffectTargets: this.attack1AreaOfEffectTargets, attack2AreaOfEffectTargets: this.attack2AreaOfEffectTargets, attack1MaximumNumberOfTargets: this.attack1MaximumNumberOfTargets, attack2MaximumNumberOfTargets: this.attack2MaximumNumberOfTargets, attack1TargetsAllowed: this.attack1TargetsAllowed, attack2TargetsAllowed: this.attack2TargetsAllowed, attacksEnabled: this.attacksEnabled, attack1WeaponType: this.attack1WeaponType, attack2WeaponType: this.attack2WeaponType, attack1WeaponSound: this.attack1WeaponSound, attack2WeaponSound: this.attack2WeaponSound, normalSkin: this.normalSkin, heroSkin: this.heroSkin }; }
}
