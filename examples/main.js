...
// Create the viewer!
let viewer = new GhostWolfModelViewer.ModelViewer(canvas);
...
let scene = new GhostWolfModelViewer.Scene();
...
viewer.addHandler(GhostWolfModelViewer.Bmp);
...
viewer.addHandler(GhostWolfModelViewer.Obj);
...
let q = GhostWolfModelViewer.glMatrix.quat.setAxisAngle([], GhostWolfModelViewer.glMatrix.vec3.normalize([], [1, 1, 1]), Math.PI / 120);
let q2 = GhostWolfModelViewer.glMatrix.quat.setAxisAngle([], GhostWolfModelViewer.glMatrix.vec3.normalize([], [1, 1, 1]), Math.PI / 30);
